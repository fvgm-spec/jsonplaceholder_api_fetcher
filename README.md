...
The code contained in this repository fetches data from the [JSONPlaceholder API](https://jsonplaceholder.typicode.com/), formats it using Pydantic models, and then stores it as a Delta table.
